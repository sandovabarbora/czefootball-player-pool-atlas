...
EN: dict[str, str] = {
    ...
    "slide.4b.a": "Players who arrive in the top-{topn} at 21 produce {y21} ({lo}–{hi}) league-adjusted G+A per 90 over their first two seasons; those arriving at 24, {y24} ({lo24}–{hi24}) — a difference of <strong>{diff}</strong> ({dlo}–{dhi}). {Adj} exports arrive at a median age of {age_home}.",
