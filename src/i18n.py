...
EN: dict[str, str] = {
    ...
    "ch4.series.caption": "How to read it: the acid line is the observed count, the pale band the model\u2019s fitted level; the dashed rule is the most probable break season with its posterior probability; past the divider on the right, the one-season forecast with its 90 % interval.",
