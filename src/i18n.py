...
EN: dict[str, str] = {
    ...
    "why_funnel.figure.caption": "Each rung is one stage on its own scale: the filled dot is {nation}, the open dots the two comparison countries, each with its value.",
    ...
    "slide.5.caption": "{Adj} in oxblood; each row's value written at its dot.",
    ...
    "slide.8.caption": "Country codes labelled at both ends of each line; no legend.",
    ...
    "ch4.series.caption": "The break season and its posterior probability, marked on the curve.",
