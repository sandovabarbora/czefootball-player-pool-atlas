...
EN: dict[str, str] = {
    ...
    "slide.8b.how": "{min}-minute floor, {season} rosters, same K = {phantom} shrinkage as the rest of the report; a comparison of two pathways inside one nation, not a causal claim.",
